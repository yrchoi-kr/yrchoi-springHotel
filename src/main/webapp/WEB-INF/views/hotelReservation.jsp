...
<body class=abody>
    ...
    <div id="container">
        <!-- 갤러리최근게시물영역 -->
        <div style="float: left; width: 36%;padding-left:5%;margin-top: 5%;">
            <div>
                <h2 style="border: 1px solid; width: 380px;color: white;text-align: center;;border-radius:10px;">검색</h2>
            </div>
        ...
        <div class="reservationMid" style=" float: left; width: 32%;padding-left:5%;margin-top: 5%;">
            <h2 style="border: 1px solid; width: 300px;color: white;text-align: center;;border-radius:10px;">예약 관리</h2>
            <div>
            ...
            <div style="margin-left:60px;margin-top: 3%;">
                <button class="btn btn-primary" type="submit" name =createRoom style="width:55px;" onclick="">등록</button>
                <button class="btn btn-danger" type="submit" name =deleteRoom  style="width:55px;" onclick="">삭제</button>
                <button class="btn btn-warning" type="reset" name =clearForm  style="width:60px;" onclick="">Clear</button>
            </div>
        </div>
        <div style=" float: left; width: 29%;padding-left:5%;margin-top: 5%;">
